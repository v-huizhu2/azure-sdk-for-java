...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(AzureAlertsManagementServiceResourceProviderImpl client) {
        this.service
    ...
    /**
     * The interface defining all the services for AzureAlertsManagementServiceResourceProviderOperations to be used by
     * the proxy service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "AzureAlertsManagementServiceResourceProviderOperations")
