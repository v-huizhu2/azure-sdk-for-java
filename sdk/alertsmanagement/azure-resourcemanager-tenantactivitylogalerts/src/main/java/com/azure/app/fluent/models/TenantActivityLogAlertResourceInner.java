...
public final class TenantActivityLogAlertResourceInner extends Resource {
    ...
    /**
     * Get the tenantScope property: The tenant GUID. Must be provided for tenant-level and management group events
     * rules.
     * 
     * @return the tenantScope value.
     */
    public String tenantScope() {
        return this.innerProperties() == null ? null : this.innerProperties().tenantScope();
    }

    /**
     * Set the tenantScope property: The tenant GUID. Must be provided for tenant-level and management group events
     * rules.
     * 
     * @param tenantScope the tenantScope value to set.
    ...
    public TenantActivityLogAlertResourceInner withTenantScope(String tenantScope) {
        ...
        this.innerProperties().withTenantScope(tenantScope);
        return this;
    }
        ...
        if (innerProperties() == null) {
            throw LOGGER.atError()
                .log(new IllegalArgumentException(
                    "Missing required property innerProperties in model TenantActivityLogAlertResourceInner"));
        } else {
            innerProperties().validate();
        }
    }

    private static final ClientLogger LOGGER = new ClientLogger(TenantActivityLogAlertResourceInner.class);
     ...
     * @return An instance of TenantActivityLogAlertResourceInner if the JsonReader was pointing to an instance of it,
     * or null if it was pointing to JSON null.
     * @throws IllegalStateException If the deserialized JSON object was missing any required properties.
     * @throws IOException If an error occurs while reading the TenantActivityLogAlertResourceInner.
     */
    public static TenantActivityLogAlertResourceInner fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            TenantActivityLogAlertResourceInner deserializedTenantActivityLogAlertResourceInner
                = new TenantActivityLogAlertResourceInner();
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                String fieldName = reader.getFieldName();
                reader.nextToken();

                if ("id".equals(fieldName)) {
                    deserializedTenantActivityLogAlertResourceInner.id = reader.getString();
            ...
            return deserializedTenantActivityLogAlertResourceInner;
        });
    }
}
