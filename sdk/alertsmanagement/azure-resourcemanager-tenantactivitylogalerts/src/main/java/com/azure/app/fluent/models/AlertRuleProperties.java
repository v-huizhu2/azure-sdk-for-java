...
public final class AlertRuleProperties implements JsonSerializable<AlertRuleProperties> {
     ...
     */
    public AlertRuleProperties withTenantScope(String tenantScope) {
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeStringField("tenantScope", this.tenantScope);
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("condition".equals(fieldName)) {
                    deserializedAlertRuleProperties.condition = AlertRuleAllOfCondition.fromJson(reader);
                } else if ("actions".equals(fieldName)) {
                    deserializedAlertRuleProperties.actions = ActionList.fromJson(reader);
                } else if ("tenantScope".equals(fieldName)) {
                    deserializedAlertRuleProperties.tenantScope = reader.getString();
