...
public final class AlertRuleRecommendationProperties implements JsonSerializable<AlertRuleRecommendationProperties> {
    ...
    /**
     * Get the category property: The recommendation alert rule category.
     * 
    ...
    /**
     * Set the category property: The recommendation alert rule category.
     * 
     * @param category the category value to set.
     * @return the AlertRuleRecommendationProperties object itself.
     */
    public AlertRuleRecommendationProperties withCategory(String category) {
        ...
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("alertRuleType".equals(fieldName)) {
                    ...
                    deserializedAlertRuleRecommendationProperties.category = reader.getString();
                } else {
                    reader.skipChildren();
                }
            }
